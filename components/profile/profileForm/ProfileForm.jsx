      ...
      <FormProvider>
        ...
        >
          ...
          <InputField
            ...
            autoFocus={false}
            onClick={() =>
              toast.info(`Email can't be changed right now. Sorry.`)
            } //*Email change not implemented. If the user wants to change their email, it will have to sync with firebase auth.
            register={register}
            errors={errors}
            readOnly={true}
          />
