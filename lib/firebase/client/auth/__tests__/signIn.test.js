...
import checkVerificationEmail from '../signIn/checkVerificationEmail';
import { getUserProfile } from 'lib/firebase/client/auth/signIn/getUserProfile';
import { manageSignIn } from '../signIn/manageSignIn';
import { signIn } from '../signIn/signIn';

jest.mock('../../config');
jest.mock('firebase/auth');
jest.mock('firebase/firestore');
jest.mock('../signIn/checkVerificationEmail', () => ({
  checkVerificationEmail: jest.fn(),
}));
